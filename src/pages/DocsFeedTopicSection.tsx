...
/** Mimics slide-mode markdown chrome while lazy-mount waits on intersection (fast scroll). */
function DocsFeedMarkdownSkeleton({ loadingLabel }: { loadingLabel: string }) {
