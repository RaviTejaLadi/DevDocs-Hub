...
const NavBar = () => {
  ...
  return (
    <header className="sticky top-[max(0.5rem,env(safe-area-inset-top))] rounded-md z-50 w-[min(100%,calc(100vw-env(safe-area-inset-left)-env(safe-area-inset-right)-1px))] mx-auto max-w-full border border-border/40 bg-card/72 backdrop-blur-md supports-backdrop-filter:bg-card/62 dark:bg-background/95 dark:supports-backdrop-filter:bg-background/80 box-border shadow-[var(--panel-shadow-raised,none)] dark:shadow-none">
