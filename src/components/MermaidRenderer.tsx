...
const initMermaid = (isDark: boolean) => {
  mermaid.initialize({
    ...
    //   labelTextColor:       '#c8cae0',
      ...
      // Pie
      pie1: '#6b7ab5', pie2: '#4a8fa8', pie3: '#5a9e7a',
      pie4: '#8a6bab', pie5: '#b57a4a', pie6: '#ab4a6b',
      pie7: '#4a6bab', pie8: '#7aab5a',
      pieTextColor:         '#f0f0f5',
      ...
      // Git
      git0: '#6b7ab5', git1: '#4a8fa8', git2: '#5a9e7a',
      git3: '#8a6bab', git4: '#b57a4a', git5: '#ab4a6b',
      git6: '#4a6bab', git7: '#7aab5a',
    ...
    //   labelTextColor:       '#2a2d45',
      ...
      // Pie
      pie1: '#5a6aa8', pie2: '#3a7e9a', pie3: '#4a8e6a',
      pie4: '#7a5a9a', pie5: '#a56a3a', pie6: '#9a3a5a',
      pie7: '#3a5a9a', pie8: '#6a9a4a',
      pieTextColor:         '#1a1c2e',
      ...
      // Git
      git0: '#5a6aa8', git1: '#3a7e9a', git2: '#4a8e6a',
      git3: '#7a5a9a', git4: '#a56a3a', git5: '#9a3a5a',
      git6: '#3a5a9a', git7: '#6a9a4a',
      gitBranchLabel0: '#ffffff', gitBranchLabel1: '#ffffff',
      gitBranchLabel2: '#ffffff', gitBranchLabel3: '#ffffff',
      gitBranchLabel4: '#ffffff', gitBranchLabel5: '#ffffff',
      gitBranchLabel6: '#ffffff', gitBranchLabel7: '#ffffff',
