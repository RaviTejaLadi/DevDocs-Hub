...
const CATEGORY_TOOLTIPS = {
  mutator: 'Mutator methods change the array in place.',
  accessor: 'Accessor methods return new values without mutating.',
  iteration: 'Iteration methods loop with callbacks.',
  search: 'Search methods find or test elements.',
  static: 'Static methods are called on Array, not instances.',
} as const;
            ...
            <Card className="border-violet-500/20 shadow-none">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2 rounded-lg border border-border/35 bg-muted/30 px-3 py-2">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>{'Re-run when inputs change'}</TooltipContent>
                    </Tooltip>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="array-input">{'Input array (JSON)'}</Label>
                  <Textarea
                    id="array-input"
                    value={arrayInput}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label className="text-xs text-muted-foreground">
                        {selectedMethod.mutates ? 'Array after (mutated copy)' : 'Original array (unchanged)'}
                      </Label>
