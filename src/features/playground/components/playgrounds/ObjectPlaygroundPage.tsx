            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                <h1 className="text-xl sm:text-2xl font-bold tracking-tight">
                  {t('playground.objectsTitle')}
                </h1>

                <p className="text-sm text-muted-foreground mt-0.5 max-w-xl">
                  {t('playground.objectsDescription')}
                </p>
              </div>
            </div>
          </div>
        ...
        <Card className="hidden lg:flex flex-col border-border/40 bg-card/60 min-h-[520px]">
          <CardHeader className="pb-2 shrink-0">
            <CardTitle className="text-sm font-medium">
              {t('playground.methodsList')}
            </CardTitle>

            <CardDescription className="text-xs">
              {t('playground.searchMethods')}
            </CardDescription>
          </CardHeader>
            ...
            <CardContent className="py-3 px-4">
              <div className="flex flex-wrap items-center gap-2 justify-between">
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto">
                  <Sheet
                    open={mobileMethodsOpen}
                    onOpenChange={setMobileMethodsOpen}
                  >
                    ...
                    <SheetContent
                      side="left"
                      className="w-[min(100vw-2rem,340px)] flex flex-col p-0"
                    >
                      <SheetHeader className="px-4 pt-4 pb-2 text-left">
                        <SheetTitle>
                          {t('playground.browseMethods')}
                        </SheetTitle>
                  ...
                  >
                    {selectedMethod.mutates
                      ? t('playground.mutates')
                      : t('playground.nonMutating')}
                  </Badge>
                </div>
              </div>
            </CardContent>
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Badge
                      variant="outline"
                      className="text-xs capitalize shrink-0 cursor-default"
                    >
                      {
                        OBJECT_METHOD_CATEGORIES[selectedMethod.category]
                          .label
                      }
                    </Badge>
                  </TooltipTrigger>
                  ...
                  <TooltipContent className="max-w-xs">
                    {t(
                      CATEGORY_TOOLTIP_KEYS[selectedMethod.category]
                    )}
                  </TooltipContent>
                </Tooltip>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="relative group rounded-lg border border-dashed border-border/40 bg-muted/20 p-3">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      copyText('example', selectedMethod.example)
                    }
                  >
                    {copiedKey === 'example' ? (
                ...
                {selectedMethod.extraArgsLabel && (
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      placeholder={
                        selectedMethod.extraArgsPlaceholder
                      }
                    />
                  </div>
                )}
                ...
                {!runResult ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label className="text-xs text-muted-foreground">
                        {selectedMethod.mutates
                          ? t('playground.objectAfter')
                          : t('playground.objectUnchanged')}
                      </Label>
