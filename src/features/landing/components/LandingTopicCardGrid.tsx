  ...
  return (
    <>
      <div className="flex min-h-0 flex-1 items-start gap-3 overflow-hidden">
        <div
          className={cn('shrink-0 rounded-md p-2 [&_svg]:size-5', color.iconBg, color.iconColor)}
        >
          {topic.icon}
        </div>
        <div className="min-w-0 flex-1 overflow-hidden">
          <div className="flex items-start justify-between gap-2">
            ...
            <span className="shrink-0 rounded-md border border-border/40 bg-muted/35 px-1.5 py-0.5 text-[10px] font-medium leading-none text-muted-foreground/90">
