...
export function LandingTopicCard({ topic, colorIndex, viewMode, onSelect }: LandingTopicCardProps) {
  ...
  return (
    <article
      ...
      className={cn(
        'group relative min-w-0 max-w-full cursor-pointer overflow-hidden rounded-xl border border-border/35 tahoe-glass text-card-foreground touch-manipulation',
