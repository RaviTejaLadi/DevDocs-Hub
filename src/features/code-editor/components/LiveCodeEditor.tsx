...
import { useLiveCodeEditor, useSandpackEditorHeight } from '../hooks';
import type { LiveCodeEditorProps } from '../types';
...
export function LiveCodeEditor({ className, defaultPreset = 'react' }: LiveCodeEditorProps) {
  ...
  const { setActivePreset, selectedPreset, sandpackTheme, editorExtensions, layoutStyle } =
    useLiveCodeEditor(defaultPreset);
