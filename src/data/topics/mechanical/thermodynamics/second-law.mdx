# 2⃣ Second Law of Thermodynamics
...
<!-- Visual flow for 2⃣ Second Law of Thermodynamics. -->
```mermaid
flowchart LR
...
// Example demonstrating 2⃣ Second Law of Thermodynamics.
```
Efficiency < 100%
```
