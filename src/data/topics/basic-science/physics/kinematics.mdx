...
Kinematics is the branch of mechanics that describes motion without considering its causes. It deals with position, velocity, acceleration, and time relationships.
