...
**Geospatial Queries** is a technical concept you should be able to explain in plain language before relying on memorisation. A useful way to learn it is to connect the definition to a concrete example, then identify the conditions that make the example valid.
