...
### 1.1 🕳 The One-Way Mathematical Trapdoor
...
### 2.2 ⚠ Vulnerabilities and Padding
...
### 3.2 ⚖ The Advantage of ECC over RSA
...
### 4.3 🕵‍♂ Ephemeral Diffie-Hellman (DHE / ECDHE)
...
<!-- Visual flow for 🗝 Asymmetric Encryption (Public Key Cryptography). -->
```mermaid
graph TD
