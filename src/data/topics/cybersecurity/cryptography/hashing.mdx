...
## 1. 🏗️ Core Properties of a Cryptographic Hash Function
...
### 1.3 🛡️ Second Pre-image Resistance
...
### 3.1 🏎️ The Problem with Fast Hashes
...
## 4. 🏷️ Message Authentication Codes (MACs)
...
## 5. ⚠️ Practical Implementation and Pitfalls
