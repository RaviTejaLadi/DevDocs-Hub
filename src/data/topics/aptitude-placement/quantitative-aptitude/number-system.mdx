...
The Number System is the foundation of Quantitative Aptitude. Almost every
aptitude topic directly or indirectly depends on number properties and
arithmetic operations.

Understanding the Number System helps in solving problems related to
divisibility, factors, multiples, remainders, HCF, LCM, and many advanced
aptitude concepts.
...
A number is a mathematical value used for counting, measuring, and performing
calculations.
...
When a number does not divide completely, the leftover part is called the
remainder.
...
- Numbers are classified into natural, whole, integers, rational, irrational,
  and real numbers.
